			...
			<div class="stats shadow-xl w-full border border-base-content/10">
				<div class="stat">
					<div class="stat-figure">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" class:text-success={stats.latestHealthCheckState === 'ok'} class:text-error={stats.latestHealthCheckState === 'error'} class:text-warning={stats.latestHealthCheckState !== 'ok' && stats.latestHealthCheckState !== 'error'}>
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>
					</div>
